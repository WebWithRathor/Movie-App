...
const Header = ({ wallpaper }) => {
    ...
    return (
        <div
            ...
            <Link to={`/${wallpaper.media_type}/details/${wallpaper.id}/trailer/${wallpaper.id}`} className='px-10 py-3 mt-5 bg-violet-500 hover:bg-zinc-200 hover:text-violet-600 transition-all rounded font-semibold w-fit'>Watch Now</Link>
        </div>
    )
}
