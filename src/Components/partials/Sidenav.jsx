  ...
  return (
    <div className='w-full h-screen  text-white border-r-2'>
        ...
        <ul className='mt-8'>
            ...
            <Link className='w-full inline-block py-2 px-6 font-semibold hover:text-black transition-all cursor-pointer hover:bg-gray-200'><i className="ri-movie-2-fill mr-3"></i> Movie</Link>
            <Link className='w-full inline-block py-2 px-6 font-semibold hover:text-black transition-all cursor-pointer hover:bg-gray-200'><i className="ri-tv-2-fill mr-3"></i> Tv Shows</Link>
            <Link className='w-full inline-block py-2 px-6 font-semibold hover:text-black transition-all cursor-pointer hover:bg-gray-200'><i className="ri-team-fill mr-3"></i> People</Link>
            <Link className='w-full inline-block py-2 px-6 font-semibold hover:text-black transition-all cursor-pointer hover:bg-gray-200'><i className="ri-sparkling-2-fill mr-3"></i> Popular</Link>
