...
const Topnav = () => {
  ...
  return (
    <div className='w-full pt-4 flex relative justify-center gap-10 text-white pb-2'>
      ...
      <div className={`${query === '' ? 'hidden' : 'inline-block'} rounded space-y-1  absolute top-full  results w-2/5 max-h-[50vh] overflow-hidden z-[9999] bg-gray-700 overflow-y-auto`}>
